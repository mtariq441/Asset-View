...
import { Calendar, MapPin, User, ArrowRight, Menu, X, Star } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans overflow-x-hidden selection:bg-thrive-purple selection:text-white">
      ...
      <nav className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? "bg-white/95 backdrop-blur-md shadow-md py-2" : "bg-transparent py-4"}`}>
        <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
          <div className="flex items-center gap-2">
            <img 
              src="/attached_assets/Thrive_Logo_Date_5-7_June[1]_1765391587459.png" 
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Button className="bg-thrive-gold hover:bg-white hover:text-thrive-plum text-thrive-plum font-heading uppercase tracking-wider rounded-none px-6 border border-thrive-gold transition-all duration-300">
              Register Now
            </Button>
          </div>
          ...
          <div className="md:hidden">
            <Sheet>
              ...
              <SheetContent side="right" className="bg-thrive-ivory border-l-thrive-gold">
      ...
      <section className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
            <div className="absolute inset-0 bg-thrive-plum/70 z-10 mix-blend-multiply"></div>
            <div className="absolute inset-0 bg-gradient-to-t from-thrive-plum via-transparent to-transparent z-10"></div>
            <img 
              src="/attached_assets/Gemini_Generated_Image_usek40usek40usek[1]_1765391489148.png" 
              alt="Women Veterans" 
              className="w-full h-full object-cover"
            />
        </div>

        <div className="container relative z-20 px-4 md:px-6 text-center mt-16">
          <motion.div 
            initial="hidden"
            animate="visible"
            variants={fadeIn}
          ...
          >
            <div className="inline-block mb-6 border-b border-thrive-gold/60 pb-2">
            ...
            <p className="text-lg md:text-2xl text-thrive-ivory/90 max-w-3xl mb-12 font-light leading-relaxed drop-shadow-md">
            ...
            <motion.div 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Button size="lg" className="h-16 px-12 bg-gradient-to-r from-thrive-gold via-[#e8c06e] to-thrive-gold hover:via-white text-thrive-plum font-heading font-bold text-xl tracking-widest uppercase rounded-sm shadow-[0_0_30px_rgba(217,164,65,0.4)] transition-all border border-white/20">
                Secure Your Seat
              </Button>
            </motion.div>
          </motion.div>
      ...
      <section id="about" className="py-32 bg-thrive-ivory relative overflow-hidden">
        <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-thrive-orchid/20 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-thrive-gold/10 rounded-full blur-[120px] translate-x-1/3 translate-y-1/3"></div>
          ...
          <div className="grid md:grid-cols-2 gap-20 items-center">
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-4 border-2 border-thrive-gold/30 rounded-none z-0 translate-x-4 translate-y-4 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform duration-500"></div>
                <div className="absolute -inset-4 border border-thrive-purple/10 rounded-none z-0 -translate-x-4 -translate-y-4 group-hover:-translate-x-2 group-hover:-translate-y-2 transition-transform duration-500"></div>
                <img 
                  src="/attached_assets/Gemini_Generated_Image_r1iosrr1iosrr1io[1]_1765391540131.png" 
            ...
            >
              <h2 className="text-thrive-purple text-5xl md:text-6xl font-heading font-bold mb-8 leading-tight">
                Stronger <br/><span className="text-transparent bg-clip-text bg-gradient-to-r from-thrive-gold to-[#bfa060] italic font-serif">Together</span>
              </h2>
      ...
      <section id="speakers" className="py-32 bg-thrive-plum text-thrive-ivory relative">
         <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#4a236e] to-thrive-plum opacity-50"></div>
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-heading font-bold mb-6 text-white">Distinguished Speakers</h2>
            <div className="w-32 h-1 bg-gradient-to-r from-transparent via-thrive-gold to-transparent mx-auto mb-8"></div>
              ...
              <motion.div key={index} variants={fadeIn}>
                <Card className="bg-transparent border-0 rounded-none overflow-hidden group">
                  <div className="aspect-[3/4] overflow-hidden relative mb-6">
                    <div className="absolute inset-0 border-2 border-thrive-gold/0 group-hover:border-thrive-gold/100 transition-all duration-500 z-20 pointer-events-none inset-x-4 inset-y-4"></div>
                    <div className="absolute inset-0 bg-thrive-purple/20 group-hover:bg-transparent transition-colors duration-500 z-10"></div>
                    <img 
                      src={speaker.image} 
                      alt={speaker.name} 
      ...
      <section id="schedule" className="py-32 bg-white relative">
        <div className="container mx-auto px-4 md:px-6">
           <div className="flex flex-col md:flex-row justify-between items-end mb-20 gap-8 border-b border-gray-100 pb-10">
            ...
            <Button className="bg-thrive-plum hover:bg-thrive-purple text-white px-8 h-12 uppercase tracking-wider font-medium text-xs">Download Full PDF</Button>
          </div>

          <div className="relative">
             {/* Timeline Line */}
            <div className="absolute left-0 md:left-1/2 top-0 bottom-0 w-px bg-thrive-gold/30 hidden md:block"></div>
              ...
              {schedule.map((item, index) => (
                <div key={index} className={`flex flex-col md:flex-row gap-8 items-center ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                  <div className="w-full md:w-1/2 flex md:justify-end justify-start md:px-16">
                     <div className={`bg-thrive-ivory/50 p-8 md:p-10 rounded-sm hover:shadow-lg transition-all duration-300 w-full max-w-lg border border-transparent hover:border-thrive-gold/20 group relative overflow-hidden ${index % 2 === 0 ? 'md:text-right' : ''}`}>
                  ...
                  {/* Timeline Dot */}
                  <div className="hidden md:flex absolute left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-thrive-gold shadow-[0_0_0_8px_white] items-center justify-center z-10">
                  </div>
                  
                  <div className={`w-full md:w-1/2 flex md:justify-end justify-start md:px-16 ${index % 2 === 0 ? 'md:justify-start' : ''}`}>
                    <span className="text-3xl font-heading font-bold text-thrive-gold/40">{item.time}</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-32 bg-thrive-gold relative overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-thrive-gold via-[#e8c06e] to-thrive-gold opacity-90"></div>
        ...
        <div className="container mx-auto px-4 md:px-6 text-center relative z-10">
          ...
          >
            <Star className="w-16 h-16 text-thrive-plum mx-auto mb-8 fill-thrive-plum" />
            ...
            <Button size="lg" className="h-20 px-16 bg-thrive-plum text-white hover:bg-thrive-purple hover:scale-105 transition-all duration-300 font-heading text-xl uppercase tracking-[0.2em] shadow-2xl border-2 border-transparent hover:border-thrive-orchid/30">
              Register for Summit
            </Button>
          </motion.div>
        </div>
      ...
      {/* Footer */}
      <footer className="bg-[#1a0b2e] text-thrive-ivory py-20 border-t border-thrive-gold/10">
        <div className="container mx-auto px-4 md:px-6">
